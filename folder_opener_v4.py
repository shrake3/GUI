...
c.execute("CREATE TABLE IF NOT EXISTS opaque(trans int)")
conn.commit()
...
def change_folder():
    ...
    pass_btn = Button(frame6, text="Change Password",activebackground="grey70", font=("",8,"bold"), fg="white", bg="grey60", command=change_password, border=0, padx=17).place(x=0, y=0)
    fold_btn = Button(frame6, text="Change Folder", activebackground="grey70", font=("",8,"bold"), fg="white", bg="grey50", command=change_folder, border=0, padx=20).place(x=140, y=0)
    trans = Button(frame6, text="opaque", activebackground="grey70", font=("",8,"bold"), fg="white", bg="grey60", command=transparent, border=0, padx=13).place(x=260, y=0)
...
def radio_select():
    selection = var.get()
    val = selection/10
    # print("selection is :",val)
    root.attributes("-alpha",val)
    c.execute("UPDATE opaque SET trans=?",(selection,))
    conn.commit()

def transparent():

    pass_btn = Button(frame6, text="Change Password",activebackground="grey70", font=("",8,"bold"), fg="white", bg="grey60", command=change_password, border=0, padx=17).place(x=0, y=0)
    fold_btn = Button(frame6, text="Change Folder", activebackground="grey70", font=("",8,"bold"), fg="white", bg="grey60", command=change_folder, border=0, padx=20).place(x=140, y=0)
    trans = Button(frame6, text="opaque", activebackground="grey70", font=("",8,"bold"), fg="white", bg="grey50", command=transparent, border=0, padx=13).place(x=260, y=0)
    ...
    text1 = Label(frame3, bg="grey40", fg="white", text="Opaque").place(x=10, y=10)
    text2 = Label(frame3, bg="grey40", fg="white", text="Transparency").place(x=320, y=10)

    r1 = Radiobutton(frame3, variable=var, activebackground="grey40", bg="grey40", value=10).place(x=20, y=50)
    r2 = Radiobutton(frame3, variable=var, activebackground="grey40", bg="grey40", value=9).place(x=55, y=50)
    r3 = Radiobutton(frame3, variable=var, activebackground="grey40", bg="grey40", value=8).place(x=90, y=50)
    r4 = Radiobutton(frame3, variable=var, activebackground="grey40", bg="grey40", value=7).place(x=125, y=50)
    r5 = Radiobutton(frame3, variable=var, activebackground="grey40", bg="grey40", value=6).place(x=160, y=50)
    r6 = Radiobutton(frame3, variable=var, activebackground="grey40", bg="grey40", value=5).place(x=195, y=50)
    r7 = Radiobutton(frame3, variable=var, activebackground="grey40", bg="grey40", value=4).place(x=230, y=50)
    r8 = Radiobutton(frame3, variable=var, activebackground="grey40", bg="grey40", value=3).place(x=265, y=50)
    r9 = Radiobutton(frame3, variable=var, activebackground="grey40", bg="grey40", value=2).place(x=300, y=50)
    r10 = Radiobutton(frame3, variable=var, activebackground="grey40", bg="grey40", value=1).place(x=335, y=50)

    k=20
    for i in range(10,0,-1):
        if i is 10:
            rbl = Label(frame3, text=1, bg="grey40", fg="white").place(x=k+4, y=70)
        else:
            rbl = Label(frame3, text='0.'+str(i), bg="grey40", fg="white").place(x=k, y=70)
        k += 35
    ...
    save_btn = Button(frame3, text='   save  ', font=("",9,"bold"), bg="grey40", fg="white", command=radio_select, border=0, padx=3, pady=3).place(x=120, y=130)

    close_btn = Button(frame3, text="    close   ", bg="grey40", fg="white", border=0, padx=0, pady=3, command=frame3.quit).place(x=220, y=130)
    frame3.pack()

def change_password():

    def save_change_password(event=None):
    ...
    pass_btn = Button(frame6, text="Change Password",activebackground="grey70", font=("",8,"bold"), fg="white", bg="grey50", command=change_password, border=0, padx=17).place(x=0, y=0)
    fold_btn = Button(frame6, text="Change Folder", activebackground="grey70", font=("",8,"bold"), fg="white", bg="grey60", command=change_folder, border=0, padx=20).place(x=140, y=0)
    trans = Button(frame6, text="opaque", activebackground="grey70", font=("",8,"bold"), fg="white", bg="grey60", command=transparent, border=0, padx=13).place(x=260, y=0)
    ...
    new_2.bind('<Return>', save_change_password)
...
def setting():
    ...
    login_btn = Button(frame6, text="Login", activebackground="grey70", font=("",8,"bold"), fg="white", bg="grey60", command=login, border=0,padx=16).place(x=333, y=0)
    frame6.pack()
    change_password()
    pass_btn = Button(frame6, text="Change Password",activebackground="grey70", font=("",8,"bold"), fg="white", bg="grey50", command=change_password, border=0, padx=17).place(x=0, y=0)
...
c.execute("SELECT trans FROM opaque")
conn.commit()
val = c.fetchone()

if val==None:
    c.execute("INSERT INTO opaque VALUES(10)")
    conn.commit()
    val = 10
else:
    val = val[0]
